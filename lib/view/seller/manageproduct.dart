...
class ManageProductPage extends StatefulWidget {
  final User user;
  const ManageProductPage({Key? key, required this.user}) : super(key: key);
...
class _ManageProductPageState extends State<ManageProductPage> {
  ...
  final TextEditingController _prpriceEditingController =
      TextEditingController();
  final TextEditingController _prquantityEditingController =
      TextEditingController();
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                        ...
                        validator: (val) =>
                            val!.isEmpty ? "The stock cannot be 0" : null,
                        focusNode: focus3,
                        controller: _prquantityEditingController,
                        keyboardType: TextInputType.number,
                        decoration: const InputDecoration(
                          labelText: 'Stock',
                          labelStyle: TextStyle(),
  ...
  void _addNewProduct() {
    ...
    String _prquantity = _prquantityEditingController.text;
    ...
    http.post(Uri.parse(Config.server + "/info_pc/php/new_product.php"), body: {
      "prname": _prname,
      "prdesc": _prdesc,
      "prprice": _prprice,
